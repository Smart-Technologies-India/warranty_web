...
const AddUserPage = () => {
  ...
  const roleOptions = [
    ...
    { label: "Manufacturer Gen. Tech.", value: "MANUF_TECH_GEN" },
    { label: "Manufacturer Tech. Expert", value: "MANUF_TECH_EXPERT" },
    { label: "Manufacturer Tech. Manager", value: "MANUF_TECH_MANAGER" },
