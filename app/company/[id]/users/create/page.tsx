...
const ROLE_OPTIONS = [
  ...
  { label: "Gen. Technical", value: "MANUF_TECH_GEN" },
  { label: "Technical Expert", value: "MANUF_TECH_EXPERT" },
  { label: "Technical Manager", value: "MANUF_TECH_MANAGER" },
];
...
const CreateUserPage = () => {
  ...
  const createMutation = useCreateCompanyUserMutation({
    companyId,
    createdById: userId,
  });
  ...
  const onSubmit = (data: AddUserForm) => {
    ...
    const input = {
      ...
      password: `${data.name.charAt(0).toUpperCase()}${data.name.replaceAll(" ", "").slice(1, 4).toLowerCase()}@${data.contact1.slice(-4)}`,
    };
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                      ...
                      <p className="text-purple-700 text-sm">
                        Full system access, user management, and administrative
                        privileges
                      </p>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                      ...
                      <p className="text-blue-700 text-sm">
                        Team management, operational oversight, and strategic
                        planning
                      </p>
                    </div>
                    ...
                    <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                      ...
                      <p className="text-orange-700 text-sm">
                        Customer relationships, sales operations, and revenue
                        generation
                      </p>
                    </div>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 md:col-span-2 lg:col-span-1">
                      ...
                      <p className="text-gray-700 text-sm">
                        Technical support, system maintenance, and product
                        expertise
                      </p>
                    </div>
                  </div>
